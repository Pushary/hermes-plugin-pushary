...
SYSTEM_PROMPT_SECTION = (
    ...
    "pushary_propose_scope only for an unresolved or requested boundary; only file "
    "paths are enforced, so a boundary that is not a path goes in promises, and an "
    "empty enforces means nothing in it is checked automatically. "
